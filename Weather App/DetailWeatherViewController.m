...
@property (weak, nonatomic) IBOutlet UIButton *moreInfoButtonTapped;
...
// the behemoth... help me Ob1... sigh. who am i kidding, there's no hope
-(void)setAnimatedWeatherSceneForIconCode {
    ...
    //nighttime canvases
        ...
        // clouds 10, moon 29, little star 30, lightning 31, 32, 33, 34
        ...
        [UIImageView animateWithDuration:1 delay:0 options:UIViewAnimationOptionCurveEaseOut animations:^{
            ...
            [UIImageView animateWithDuration:0.1 delay:0.5 options:UIViewAnimationOptionCurveEaseOut animations:^{
...
-(void)setNightTimeLabelTextColors {
    ...
    self.cityNameLabel.textColor = [[UIColor whiteColor] colorWithAlphaComponent:0.8];
    self.descriptionLabel.textColor =  [[UIColor whiteColor] colorWithAlphaComponent:0.8];
    self.tempLabel.textColor =  [[UIColor whiteColor] colorWithAlphaComponent:0.8];
    self.moreInfoLabel.textColor =  [[UIColor cyanColor] colorWithAlphaComponent:0.5];
    [self.moreInfoButton setTitleColor: [[UIColor cyanColor] colorWithAlphaComponent:0.5] forState:UIControlStateNormal];
}

-(void)setDayTimeTextLabelColors {
    self.cityNameLabel.textColor = [[UIColor whiteColor] colorWithAlphaComponent:0.7];
    self.descriptionLabel.textColor =  [[UIColor whiteColor] colorWithAlphaComponent:0.7];
    self.tempLabel.textColor =  [[UIColor whiteColor] colorWithAlphaComponent:0.7];
